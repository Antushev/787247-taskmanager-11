...
const createTaskEditTemplate = (taskEdit) => {
  const {description, dueDate, color, repeatingDays} = taskEdit;
  const isExpired = dueDate instanceof Date && dueDate < Date.now();
  const isDateShowing = !!dueDate;

  const date = isDateShowing ? `${dueDate.getDate()} ${MONTHS[dueDate.getMonth()]}` : ``;
  const time = isDateShowing ? `${dueDate.getHours()}:${dueDate.getMinutes()}` : ``;
          ...
          <div class="card__settings">
            <div class="card__details">
              <div class="card__dates">
                ...
                ${isDateShowing ? `<fieldset class="card__date-deadline" disabled>
